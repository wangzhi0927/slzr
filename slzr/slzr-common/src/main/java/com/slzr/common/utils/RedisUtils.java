...
public class RedisUtils {
  ...
  public static void main(String[] args) {
	  ...
	  RedisUtil.hset("woshi", "a1", "a11");
	  RedisUtil.hset("woshi", "a2", "a22");
	  
	  //System.out.println(RedisUtil.hgetall("woshi"));
	  RedisUtil.testMap2List(RedisUtil.hgetall("woshi"));
	  
//	  RedisUtil.set("sasa", "sasa");
//	  System.out.println(RedisUtil.get("sasa"));
}
  public  List testMap2List(Map<String, String> map) {
